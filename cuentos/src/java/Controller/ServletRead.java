...
public class ServletRead extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (request.getParameter("id").equals("lista_a")) {
        ...
        } else if (request.getParameter("id").equals("lista_p")) {
        ...
        } else if (request.getParameter("id").equals("lista_r")) {
        ...
        } else if (request.getParameter("id").equals("lista_a_filtrada")) {
            Administrador admin = new Administrador();
            ArrayList<BeanAdmin> lista = admin.buscarRegistros(request.getParameter("cadena"));
            if (lista != null) {
                for (BeanAdmin beanAdmin : lista) {
                    out.println("<tr>");
                    out.println("<th scope=\"row\">" + beanAdmin.getId_adm() + "</th>");
        ...
        } else if (request.getParameter("id").equals("lista_p_filtrada")) {

            Participante p = new Participante();
            ArrayList<BeanParticipante> lista = p.buscarRegistros(request.getParameter("cadena"));
            if (lista != null) {
                for (BeanParticipante beanP : lista) {
                    out.println("<tr>");
                    out.println("<th scope=\"row\">" + beanP.getId_participante() + "</th>");
        ...
        } else if (request.getParameter("id").equals("lista_r_filtrada")) {
            Revisor r = new Revisor();
            ArrayList<BeanRevisor> lista = r.buscarRegistros(request.getParameter("cadena"));
            if (lista != null) {
                for (BeanRevisor beanR : lista) {
                    out.println("<tr>");
                    out.println("<th scope=\"row\">" + beanR.getId_revisor() + "</th>");
