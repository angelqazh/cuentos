...
public class ServletUpdate extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (request.getParameter("admin_e") != null) {
            ...
            boolean r = admin.modificar(bean);
            if (r) {
        ...
        } else if (request.getParameter("participante_e") != null) {
        ...
        } else if (request.getParameter("revisor_e") != null) {
